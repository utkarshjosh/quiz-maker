// To parse this data:
//
//   import { Convert, LeaveMessage } from "./file";
//
//   const leaveMessage = Convert.toLeaveMessage(json);
//
...
export interface LeaveMessage {
    ...
    StartMessage:      LeaveMessageClass;
    AnswerMessage:     AnswerMessage;
    KickMessage:       Message;
    LeaveMessage:      LeaveMessageClass;
...
export interface LeaveMessageClass {
}
...
export class Convert {
    public static toLeaveMessage(json: string): LeaveMessage {
        return cast(JSON.parse(json), r("LeaveMessage"));
    }

    public static leaveMessageToJson(value: LeaveMessage): string {
        return JSON.stringify(uncast(value, r("LeaveMessage")), null, 2);
    }
}
...
const typeMap: any = {
    "LeaveMessage": o([
        ...
        { json: "StartMessage", js: "StartMessage", typ: r("LeaveMessageClass") },
        { json: "AnswerMessage", js: "AnswerMessage", typ: r("AnswerMessage") },
        { json: "KickMessage", js: "KickMessage", typ: r("Message") },
        { json: "LeaveMessage", js: "LeaveMessage", typ: r("LeaveMessageClass") },
    ...
    "MessageClass": o([
        ...
        { json: "data", js: "data", typ: r("LeaveMessageClass") },
    ], false),
    "NgMessage": o([
