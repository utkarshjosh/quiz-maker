// To parse this data:
//
//   import { Convert, LeftMessage } from "./file";
//
//   const leftMessage = Convert.toLeftMessage(json);
//
...
export class Convert {
    public static toLeftMessage(json: string): LeftMessage {
        return cast(JSON.parse(json), r("LeftMessage"));
    }

    public static leftMessageToJson(value: LeftMessage): string {
        return JSON.stringify(uncast(value, r("LeftMessage")), null, 2);
    }
}
