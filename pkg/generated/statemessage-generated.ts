// To parse this data:
//
//   import { Convert, StateMessage } from "./file";
//
...
export interface StateMessage {
    ...
    StateMessage:      StateMessageClass;
...
export interface StateMessageClass {
    phase:             string;
    room_id:           string;
    pin:               string;
    host_id:           string;
...
const typeMap: any = {
    "StateMessage": o([
        ...
        { json: "StateMessage", js: "StateMessage", typ: r("StateMessageClass") },
