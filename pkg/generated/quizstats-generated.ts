// To parse this data:
//
//   import { Convert, QuizStats } from "./file";
//
//   const quizStats = Convert.toQuizStats(json);
//
...
export class Convert {
    public static toQuizStats(json: string): QuizStats {
        return cast(JSON.parse(json), r("QuizStats"));
    }

    public static quizStatsToJson(value: QuizStats): string {
        return JSON.stringify(uncast(value, r("QuizStats")), null, 2);
    }
}
