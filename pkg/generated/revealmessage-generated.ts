// To parse this data:
//
//   import { Convert, RevealMessage } from "./file";
//
//   const revealMessage = Convert.toRevealMessage(json);
//
...
export interface RevealMessage {
    ...
    RevealMessage:     RevealMessageClass;
...
export interface RevealMessageClass {
    index:          number;
...
export class Convert {
    public static toRevealMessage(json: string): RevealMessage {
        return cast(JSON.parse(json), r("RevealMessage"));
    }

    public static revealMessageToJson(value: RevealMessage): string {
        return JSON.stringify(uncast(value, r("RevealMessage")), null, 2);
    }
}
...
const typeMap: any = {
    "RevealMessage": o([
        ...
        { json: "RevealMessage", js: "RevealMessage", typ: r("RevealMessageClass") },
