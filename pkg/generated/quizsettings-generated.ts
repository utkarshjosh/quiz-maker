// To parse this data:
//
//   import { Convert, QuizSettings } from "./file";
//
//   const quizSettings = Convert.toQuizSettings(json);
//
...
export class Convert {
    public static toQuizSettings(json: string): QuizSettings {
        return cast(JSON.parse(json), r("QuizSettings"));
    }

    public static quizSettingsToJson(value: QuizSettings): string {
        return JSON.stringify(uncast(value, r("QuizSettings")), null, 2);
    }
}
