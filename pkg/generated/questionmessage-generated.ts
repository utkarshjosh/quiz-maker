// To parse this data:
//
//   import { Convert, QuestionMessage } from "./file";
//
//   const questionMessage = Convert.toQuestionMessage(json);
//
...
export interface QuestionMessage {
    ...
    QuestionMessage:   QuestionMessageClass;
...
export interface QuestionMessageClass {
    index:       number;
    question:    string;
    options:     string[];
    deadline_ms: number;
...
export class Convert {
    public static toQuestionMessage(json: string): QuestionMessage {
        return cast(JSON.parse(json), r("QuestionMessage"));
    }

    public static questionMessageToJson(value: QuestionMessage): string {
        return JSON.stringify(uncast(value, r("QuestionMessage")), null, 2);
    }
}
...
const typeMap: any = {
    "QuestionMessage": o([
        ...
        { json: "QuestionMessage", js: "QuestionMessage", typ: r("QuestionMessageClass") },
