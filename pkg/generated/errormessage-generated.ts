// To parse this data:
//
//   import { Convert, ErrorMessage } from "./file";
//
//   const errorMessage = Convert.toErrorMessage(json);
//
...
export interface ErrorMessageClass {
    code:    string;
    msg:     string;
    details: string;
}
...
export class Convert {
    public static toErrorMessage(json: string): ErrorMessage {
        return cast(JSON.parse(json), r("ErrorMessage"));
    }

    public static errorMessageToJson(value: ErrorMessage): string {
        return JSON.stringify(uncast(value, r("ErrorMessage")), null, 2);
    }
}
...
const typeMap: any = {
    "ErrorMessage": o([
        ...
        { json: "ErrorMessage", js: "ErrorMessage", typ: r("ErrorMessageClass") },
