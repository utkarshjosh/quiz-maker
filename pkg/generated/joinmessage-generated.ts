// To parse this data:
//
//   import { Convert, JoinMessage } from "./file";
//
//   const joinMessage = Convert.toJoinMessage(json);
//
...
export interface JoinMessageClass {
    pin:          string;
    display_name: string;
}
...
export class Convert {
    public static toJoinMessage(json: string): JoinMessage {
        return cast(JSON.parse(json), r("JoinMessage"));
    }

    public static joinMessageToJson(value: JoinMessage): string {
        return JSON.stringify(uncast(value, r("JoinMessage")), null, 2);
    }
}
...
const typeMap: any = {
    "JoinMessage": o([
        ...
        { json: "JoinMessage", js: "JoinMessage", typ: r("JoinMessageClass") },
