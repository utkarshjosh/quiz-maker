// To parse this data:
//
//   import { Convert, PingMessage } from "./file";
//
//   const pingMessage = Convert.toPingMessage(json);
//
...
export class Convert {
    public static toPingMessage(json: string): PingMessage {
        return cast(JSON.parse(json), r("PingMessage"));
    }

    public static pingMessageToJson(value: PingMessage): string {
        return JSON.stringify(uncast(value, r("PingMessage")), null, 2);
    }
}
