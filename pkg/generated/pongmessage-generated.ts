// To parse this data:
//
//   import { Convert, PongMessage } from "./file";
//
//   const pongMessage = Convert.toPongMessage(json);
//
...
export class Convert {
    public static toPongMessage(json: string): PongMessage {
        return cast(JSON.parse(json), r("PongMessage"));
    }

    public static pongMessageToJson(value: PongMessage): string {
        return JSON.stringify(uncast(value, r("PongMessage")), null, 2);
    }
}
