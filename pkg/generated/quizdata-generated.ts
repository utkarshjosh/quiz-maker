// To parse this data:
//
//   import { Convert, QuizData } from "./file";
//
//   const quizData = Convert.toQuizData(json);
//
...
export interface QuizDataClass {
    id:        string;
    title:     string;
    questions: Question[];
}
...
export class Convert {
    public static toQuizData(json: string): QuizData {
        return cast(JSON.parse(json), r("QuizData"));
    }

    public static quizDataToJson(value: QuizData): string {
        return JSON.stringify(uncast(value, r("QuizData")), null, 2);
    }
}
...
const typeMap: any = {
    "QuizData": o([
        ...
        { json: "QuizData", js: "QuizData", typ: r("QuizDataClass") },
