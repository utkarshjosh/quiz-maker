// To parse this data:
//
//   import { Convert, UserStat } from "./file";
//
//   const userStat = Convert.toUserStat(json);
//
...
export interface RevealMessage {
    ...
    correct_index:  number;
    explanation:    string;
    user_stats:     UserStatElement[];
    leaderboard:    LeaderEntry[];
}

export interface UserStatElement {
    user_id:       string;
    display_name:  string;
    answer:        string;
    is_correct:    boolean;
...
export class Convert {
    public static toUserStat(json: string): UserStat {
        return cast(JSON.parse(json), r("UserStat"));
    }

    public static userStatToJson(value: UserStat): string {
        return JSON.stringify(uncast(value, r("UserStat")), null, 2);
    }
}
...
const typeMap: any = {
    "UserStat": o([
        ...
        { json: "UserStat", js: "UserStat", typ: r("UserStatElement") },
    ...
    "RevealMessage": o([
        ...
        { json: "correct_index", js: "correct_index", typ: 0 },
        { json: "explanation", js: "explanation", typ: "" },
        { json: "user_stats", js: "user_stats", typ: a(r("UserStatElement")) },
