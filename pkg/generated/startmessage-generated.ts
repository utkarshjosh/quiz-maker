// To parse this data:
//
//   import { Convert, StartMessage } from "./file";
//
//   const startMessage = Convert.toStartMessage(json);
//
...
export class Convert {
    public static toStartMessage(json: string): StartMessage {
        return cast(JSON.parse(json), r("StartMessage"));
    }

    public static startMessageToJson(value: StartMessage): string {
        return JSON.stringify(uncast(value, r("StartMessage")), null, 2);
    }
}
