// To parse this data:
//
//   import { Convert, LeaderEntry } from "./file";
//
//   const leaderEntry = Convert.toLeaderEntry(json);
//
...
export interface LeaderEntry {
    ...
    Member:            Member;
    UserStat:          UserStat;
    LeaderEntry:       LeaderEntryElement;
    ...
    LeaderboardEntry:  LeaderEntryElement;
...
export interface EndMessage {
    final_leaderboard: LeaderEntryElement[];
    quiz_stats:        QuizStat;
}

export interface LeaderEntryElement {
    user_id:         string;
    display_name:    string;
    score:           number;
    rank:            number;
...
export interface RevealMessage {
    ...
    explanation:    string;
    user_stats:     UserStat[];
    leaderboard:    LeaderEntryElement[];
}
...
export class Convert {
    public static toLeaderEntry(json: string): LeaderEntry {
        return cast(JSON.parse(json), r("LeaderEntry"));
    }

    public static leaderEntryToJson(value: LeaderEntry): string {
        return JSON.stringify(uncast(value, r("LeaderEntry")), null, 2);
    }
}
...
const typeMap: any = {
    "LeaderEntry": o([
        ...
        { json: "KickMessage", js: "KickMessage", typ: r("Message") },
        ...
        { json: "LeftMessage", js: "LeftMessage", typ: r("Message") },
        { json: "KickedMessage", js: "KickedMessage", typ: r("Message") },
        { json: "Member", js: "Member", typ: r("Member") },
        { json: "UserStat", js: "UserStat", typ: r("UserStat") },
        { json: "LeaderEntry", js: "LeaderEntry", typ: r("LeaderEntryElement") },
        ...
        { json: "LeaderboardEntry", js: "LeaderboardEntry", typ: r("LeaderEntryElement") },
    ...
    "EndMessage": o([
        { json: "final_leaderboard", js: "final_leaderboard", typ: a(r("LeaderEntryElement")) },
        { json: "quiz_stats", js: "quiz_stats", typ: r("QuizStat") },
    ], false),
    "LeaderEntryElement": o([
    ...
    "RevealMessage": o([
        ...
        { json: "leaderboard", js: "leaderboard", typ: a(r("LeaderEntryElement")) },
    ], false),
    "UserStat": o([
        { json: "user_id", js: "user_id", typ: "" },
        { json: "display_name", js: "display_name", typ: "" },
