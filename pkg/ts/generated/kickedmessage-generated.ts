// To parse this data:
//
//   import { Convert, KickedMessage } from "./file";
//
//   const kickedMessage = Convert.toKickedMessage(json);
//
...
export class Convert {
    public static toKickedMessage(json: string): KickedMessage {
        return cast(JSON.parse(json), r("KickedMessage"));
    }

    public static kickedMessageToJson(value: KickedMessage): string {
        return JSON.stringify(uncast(value, r("KickedMessage")), null, 2);
    }
}
