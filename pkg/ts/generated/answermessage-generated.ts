// To parse this data:
//
//   import { Convert, AnswerMessage } from "./file";
//
//   const answerMessage = Convert.toAnswerMessage(json);
//
...
export interface AnswerMessage {
    ...
    AnswerMessage:     AnswerMessageClass;
    KickMessage:       Message;
...
export interface AnswerMessageClass {
...
export class Convert {
    public static toAnswerMessage(json: string): AnswerMessage {
        return cast(JSON.parse(json), r("AnswerMessage"));
    }

    public static answerMessageToJson(value: AnswerMessage): string {
        return JSON.stringify(uncast(value, r("AnswerMessage")), null, 2);
    }
}
...
const typeMap: any = {
    "AnswerMessage": o([
        ...
        { json: "AnswerMessage", js: "AnswerMessage", typ: r("AnswerMessageClass") },
