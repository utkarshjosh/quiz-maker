// To parse this data:
//
//   import { Convert, RoomState } from "./file";
//
//   const roomState = Convert.toRoomState(json);
//
...
export class Convert {
    public static toRoomState(json: string): RoomState {
        return cast(JSON.parse(json), r("RoomState"));
    }

    public static roomStateToJson(value: RoomState): string {
        return JSON.stringify(uncast(value, r("RoomState")), null, 2);
    }
}
...
const typeMap: any = {
    "RoomState": o([
        ...
        { json: "RoomState", js: "RoomState", typ: r("RoomStateClass") },
