// To parse this data:
//
//   import { Convert, KickMessage } from "./file";
//
//   const kickMessage = Convert.toKickMessage(json);
//
...
export class Convert {
    public static toKickMessage(json: string): KickMessage {
        return cast(JSON.parse(json), r("KickMessage"));
    }

    public static kickMessageToJson(value: KickMessage): string {
        return JSON.stringify(uncast(value, r("KickMessage")), null, 2);
    }
}
