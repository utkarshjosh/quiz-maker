// To parse this data:
//
//   import { Convert, JoinedMessage } from "./file";
//
//   const joinedMessage = Convert.toJoinedMessage(json);
//
...
export interface JoinedMessage {
    ...
    JoinedMessage:     JoinedMessageClass;
    LeftMessage:       Message;
...
export interface JoinedMessageClass {
    user: Member;
}
...
export class Convert {
    public static toJoinedMessage(json: string): JoinedMessage {
        return cast(JSON.parse(json), r("JoinedMessage"));
    }

    public static joinedMessageToJson(value: JoinedMessage): string {
        return JSON.stringify(uncast(value, r("JoinedMessage")), null, 2);
    }
}
...
const typeMap: any = {
    "JoinedMessage": o([
        ...
        { json: "JoinedMessage", js: "JoinedMessage", typ: r("JoinedMessageClass") },
