// To parse this data:
//
//   import { Convert, ScoreMessage } from "./file";
//
//   const scoreMessage = Convert.toScoreMessage(json);
//
...
export interface ScoreMessage {
    ...
    ScoreMessage:      ScoreMessageClass;
...
export interface ScoreMessageClass {
    user_id:     string;
    score:       number;
    score_delta: number;
    rank:        number;
...
export class Convert {
    public static toScoreMessage(json: string): ScoreMessage {
        return cast(JSON.parse(json), r("ScoreMessage"));
    }

    public static scoreMessageToJson(value: ScoreMessage): string {
        return JSON.stringify(uncast(value, r("ScoreMessage")), null, 2);
    }
}
...
const typeMap: any = {
    "ScoreMessage": o([
        ...
        { json: "ScoreMessage", js: "ScoreMessage", typ: r("ScoreMessageClass") },
