// To parse this data:
//
//   import { Convert, CreateRoomMessage } from "./file";
//
//   const createRoomMessage = Convert.toCreateRoomMessage(json);
//
...
export interface CreateRoomMessage {
    ...
    CreateRoomMessage: CreateRoomMessageClass;
...
export interface CreateRoomMessageClass {
    quiz_id:  string;
    settings: Settings;
}
...
export class Convert {
    public static toCreateRoomMessage(json: string): CreateRoomMessage {
        return cast(JSON.parse(json), r("CreateRoomMessage"));
    }

    public static createRoomMessageToJson(value: CreateRoomMessage): string {
        return JSON.stringify(uncast(value, r("CreateRoomMessage")), null, 2);
    }
}
...
const typeMap: any = {
    "CreateRoomMessage": o([
        ...
        { json: "CreateRoomMessage", js: "CreateRoomMessage", typ: r("CreateRoomMessageClass") },
