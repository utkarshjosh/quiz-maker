// To parse this data:
//
//   import { Convert, Member } from "./file";
//
...
export class Convert {
    public static toMember(json: string): Member {
        return cast(JSON.parse(json), r("Member"));
    }

    public static memberToJson(value: Member): string {
        return JSON.stringify(uncast(value, r("Member")), null, 2);
    }
}
...
const typeMap: any = {
    "Member": o([
        ...
        { json: "Member", js: "Member", typ: r("MemberElement") },
    ...
    "JoinedMessage": o([
        { json: "user", js: "user", typ: r("MemberElement") },
    ], false),
    "MemberElement": o([
        { json: "id", js: "id", typ: "" },
        { json: "display_name", js: "display_name", typ: "" },
