// To parse this data:
//
//   import { Convert, EndMessage } from "./file";
//
//   const endMessage = Convert.toEndMessage(json);
//
...
export interface EndMessageClass {
...
export class Convert {
    public static toEndMessage(json: string): EndMessage {
        return cast(JSON.parse(json), r("EndMessage"));
    }

    public static endMessageToJson(value: EndMessage): string {
        return JSON.stringify(uncast(value, r("EndMessage")), null, 2);
    }
}
...
const typeMap: any = {
    "EndMessage": o([
        ...
        { json: "EndMessage", js: "EndMessage", typ: r("EndMessageClass") },
