// To parse this data:
//
//   import { Convert, UserStats } from "./file";
//
//   const userStats = Convert.toUserStats(json);
//
...
export class Convert {
    public static toUserStats(json: string): UserStats {
        return cast(JSON.parse(json), r("UserStats"));
    }

    public static userStatsToJson(value: UserStats): string {
        return JSON.stringify(uncast(value, r("UserStats")), null, 2);
    }
}
