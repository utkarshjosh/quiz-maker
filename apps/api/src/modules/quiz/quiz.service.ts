...
export default class QuizService {
  ...
  public async getQuizResults(quizId: string, userId: string) {
    ...
    // Get rooms for this quiz with members (participants) and basic user info
  ...
  public async getQuizzesByTags(
    ...
    if (primaryTagId) {
      ...
      // Get most played quizzes by number of rooms created
      const mostPlayedQuizIds = await prisma.quizRoom.groupBy({
        by: ['quizId'],
        _count: { quizId: true },
        orderBy: {
          _count: {
