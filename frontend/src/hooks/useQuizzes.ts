...
export const quizKeys = {
  ...
  secondaryTags: (primaryTagId: string) => [...quizKeys.all, "secondaryTags", primaryTagId] as const,
...
export const useGroupedQuizzes = (primaryTagId?: string, page: number = 1, limit: number = 10) => {
  return useQuery({
